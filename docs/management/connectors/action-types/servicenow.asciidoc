...
=======
The {sn} connector uses the https://docs.servicenow.com/bundle/sandiego-application-development/page/integrate/inbound-rest/concept/c_TableAPI.html[V2 Table API] to create ServiceNow incidents. The {sn-itsm} connector can be used for rule actions and cases. The {sn-sir} connector can only be used for cases.
...
>>>>>>> 42dc95987fb ([Security Solution][DOCS][7.12-7.15] Cases and rules support for SN connectors (#132481))
